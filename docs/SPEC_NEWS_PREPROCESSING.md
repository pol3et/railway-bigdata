...
| P1 | GAP-035 | `silver/language-id` | **Closed 2026-06-25:** cheapest deterministic classifier now uses pinned Lingua EN/DE/HU (no torch, no LLM), and is the routing input NER needs. Big defensibility payoff for tiny effort. |
